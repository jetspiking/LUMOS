...
{
    public partial class LumosKeyboardEmoticons : UserControl, ISoftKeyboard
    {
        private IKeyboardListener? _keyboardListener;

        public LumosKeyboardEmoticons()
        {
            InitializeComponent();
        }
        ...
        private void OnKeyPress(object sender, RoutedEventArgs e)
        {
            ...
            {
                this._keyboardListener?.PressedKey(button.Name, button.Content.ToString(), KeyboardTypes.Emoji);
            }
        }
    }
}

...
{
    public partial class LumosKeyboardShift : UserControl, ISoftKeyboard
    {
        private IKeyboardListener? _keyboardListener;

        public LumosKeyboardShift()
        {
            InitializeComponent();
        }
        ...
        private void OnKeyPress(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (this._keyboardListener == null) return;
                this._keyboardListener.PressedKey(button.Name, button.Content.ToString(), KeyboardTypes.Shift);
            }
        }
    }
}

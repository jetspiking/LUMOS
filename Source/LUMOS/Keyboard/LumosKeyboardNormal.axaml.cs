...
{
    public partial class LumosKeyboardNormal : UserControl, ISoftKeyboard
    {
        private IKeyboardListener? _keyboardListener;

        public LumosKeyboardNormal()
        {
            InitializeComponent();
        }
        ...
        private void OnKeyPress(object sender, RoutedEventArgs e)
        {
            ...
            {
                this._keyboardListener?.PressedKey(button.Name, button.Content.ToString(), KeyboardTypes.Default);
            }
        }
    }
}
